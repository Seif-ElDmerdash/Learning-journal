...
I finished Mid-Term Exams got Full mark except on one Exam.
...
## WEEK 6
This week was a highly productive stretch of academic and project milestones, kicking off with a strong performance on the Physics midterm and the strategic distribution of tasks for the Discrete mathematics project. Momentum carried through the following days as I successfully completed both a Discrete and a Calculus quiz, while dedicating significant time to Biochemistry; I researched, thoroughly documented with citations, and presented both the Final Lab and Final Lecture projects, securing full marks on both. Toward the end of the week, my focus shifted heavily back to the Discrete project, where I rapidly completed my theoretical portion and collaborated with a colleague on the code implementation to computationally model the central dogma. We successfully progressed from a simple 6-node directed graph to a more intricate design with $O(V^2)$ complexity, capping off the week by verifying that the code correctly generates the graph and pathing, and finalizing the comprehensive project report.
